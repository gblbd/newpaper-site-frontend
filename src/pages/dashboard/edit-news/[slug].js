    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_REACT_APP_API}/api/news-details-admin?slug=${slug}`,
          {
            method: "GET",
            headers: {
  ...
  const submitDataForm = async (e) => {
    ...
    try {
      const response = await axios.patch(
        `${process.env.NEXT_PUBLIC_REACT_APP_API}/api/edit-news-paper`,
        postData,
        {
          headers: {
  ...
  return (
    <div className="mt-10">
      ...
      <div className="bg-gray-100 mx-auto max-w-6xl  py-10 px-12 lg:px-24 shadow-xl mb-24">
        <p className="text-center font-semibold uppercase my-2">Edit news</p>
          ...
          <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
            <div className="md:w-full px-3 mb-6 md:mb-0">
              ...
              <input
                ...
                type="text"
                name="newsTitle"
                defaultValue={newsSingleData?.newsTitle}
            ...
            <div className="-mx-3 md:flex mb-6">
              ...
              <div className="md:w-1/2 px-3">
                ...
                <div>
                  ...
                  >
                    <option
                      value={categoreyList.find(
                        (category) =>
                          category._id === newsSingleData?.categoreyId
                      )}
                    >
                      {categoreyList.find(
                        (category) =>
            ...
            <div className="-mx-3 md:flex mb-2">
              <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <div>
                  ...
                  >
                    <option value={newsSingleData?.divisionName}>
                      {newsSingleData?.divisionName}
                    </option>
              ...
              <div className="md:w-1/2 px-3">
                ...
                <div>
                  ...
                  >
                    <option value={newsSingleData?.districtName}>
                      {newsSingleData?.districtName}
                    </option>
              ...
              <div className="md:w-1/2 px-3">
                ...
                <div>
                  ...
                  >
                    <option value={newsSingleData?.upazilaName}>
                      {newsSingleData?.upazilaName}
                    </option>
            ...
            <div className="-mx-3 md:flex mb-6">
              <div className="md:w-full px-3 ">
                ...
                <DefaultEditor
                  value={newsSingleData.newsDetailsText}
